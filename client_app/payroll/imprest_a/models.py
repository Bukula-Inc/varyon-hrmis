...
class Imprest_Form_20_A(BaseModel):

    name =models.CharField(max_length=255, default="", null=True)
    request_date =models.DateField(default=date.today, null=True)
    initiator =models.ForeignKey(Employee, on_delete=models.DO_NOTHING, default=None, null=True, related_name="imprest_form_20_a")
    ...
    job_title =models.ForeignKey(Designation, on_delete=models.DO_NOTHING, default=None, null=True, related_name="imprest_form_20_a_designation")
    annual_salary =models.FloatField(default=0.00, null=True)
    country =models.ForeignKey(Country, on_delete=models.DO_NOTHING, default=None, null=True, related_name="imprest_form_20_a_country")
    ...
    request_currency =models.ForeignKey(Currency, on_delete=models.DO_NOTHING, default=None, null=True,related_name="imprest_form_20_a_request_currency")
    requested_amount =models.FloatField(default=0.00, null=True)
    approved_amount =models.FloatField(default=0.00, null=True)
    requested_amount_in_reporting_currency =models.ForeignKey(Currency, on_delete=models.DO_NOTHING, default=None, null=True, related_name="imprest_form_20_a_requested_amount_in_reporting_currency")
