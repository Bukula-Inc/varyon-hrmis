...
export default class Auth {
    ...
    init_authentication () {
        ...
        this.$email = $('#email')
        this.$pwd = $('#pwd')
        let purl = lite.utils.get_location_info().href?.split("purl=")
        if(purl && lite.utils.array_has_data(purl)){
            purl = purl[1]
        }
