...
class Self_Appraisal:
    ...
    @staticmethod
    def self_appraisal(dbms, object):
        submitted_appraisals = []

        appraisal_data = dbms.get_list("Self_Appraisal", user=object.user)
        ...
        employee_appraisals = dbms.get_list("Self_Appraisal", filters={"status__in": ["Submitted"]}, user=object.user)
                ...
                if employee_data.status == utils.ok:
                    ...
                    for emp in employees:
                        submitted_appraisals.append({
                            ...
                            "date": app["appraisal_closure_date"],
                        })

        results = {
            "self_appraisal_stats": status,
