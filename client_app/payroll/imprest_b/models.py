...
def default_json():
    return list
class Imprest_Form_20_B(BaseModel):

    name =models.CharField(max_length=255, default="", null=True)
    request_date =models.DateField(default=date.today, null=True)
    initiator =models.ForeignKey(Employee, on_delete=models.DO_NOTHING, default=None, null=True, related_name="imprest_form_20_b")
    ...
    job_title =models.ForeignKey(Designation, on_delete=models.DO_NOTHING, default=None, null=True, related_name="imprest_form_20_b_designation")
    annual_salary =models.FloatField(default=0.00, null=True)
    country =models.ForeignKey(Country, on_delete=models.DO_NOTHING, default=None, null=True, related_name="imprest_form_20_b_country")
    ...
    request_currency =models.ForeignKey(Currency, on_delete=models.DO_NOTHING, default=None, null=True,related_name="imprest_form_20_b_request_currency")
    requested_amount =models.FloatField(default=0.00, null=True)
    approved_amount =models.FloatField(default=0.00, null=True)
    requested_amount_in_reporting_currency =models.ForeignKey(Currency, on_delete=models.DO_NOTHING, default=None, null=True, related_name="imprest_form_20_b_requested_amount_in_reporting_currency")
